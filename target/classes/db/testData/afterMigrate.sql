...
lock tables cidade write, cozinha write, estado write, forma_pagamento write, grupo write, grupo_permissao write, permissao write, produto write,
            restaurante write, restaurante_forma_pagamento write, usuario write, usuario_grupo write, restaurante_usuario_responsavel write,
...
insert into cidade (id, nome, estado_id) value (1, 'Uberlândia', 1);
insert into cidade (id, nome, estado_id) value (2, 'Belo Horizonte', 1);
insert into cidade (id, nome, estado_id) value (3, 'São Paulo', 2);
insert into cidade (id, nome, estado_id) value (4, 'Campinas', 2);
insert into cidade (id, nome, estado_id) value (5, 'Fortaleza', 3);
...
insert into restaurante (id, nome, taxa_Frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, true, false,2, '38400-999', 'Rua João Felipe', '1000', 'Centro');
insert into restaurante (id, nome, taxa_Frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (3, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp, true, false,3, '38400-999', 'Rua Carlos Felipe', '1000', 'Centro');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (4, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp, true, false,1, '38400-999', 'Rua Carlos Carmo', '1000', 'Centro');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (5, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp, true, false,2, '38400-999', 'Rua CFRdoCarmo', '1000', 'Centro');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp, true, false,3, '38400-999', 'Rua Felipe Carmo', '1000', 'Centro');
...
insert into restaurante_forma_pagamento (restaurante_id, forma_pagamento_id) values (3, 2), (4, 1), (4, 2), (5, 1), (5, 2), (6, 3);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Bife Ancho', 'Corte macio e suculento, com dois dedos de espessura, retirado da parte dianteira do contrafilé', 79, 0, 4);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Sanduíche X-Tudo', 'Sandubão com muito queijo, hamburger bovino, bacon, ovo, salada e maionese', 19, 0, 5);
...
insert into usuario (id, nome, email, senha, data_cadastro) values (1, 'Carlos Felipe', 'cfrdocarmo.ger@gmail.com', '$2a$12$8fLTl1LARsJOPZTgySjpre0FUraYHXNUtlB0eAdkAnOku8r.m.ZGu', utc_timestamp);
...
insert into usuario (id, nome, email, senha, data_cadastro) values (6, 'Débora Mendonça', 'cfrdocarmo@gmail.com', '$2y$12$NSsM4gEOR7MKogflKR7GMeYugkttjNhAJMvFdHrBLaLp2HzlggP5W', utc_timestamp);
...
values (
           'cfrdocarmofood-web', null, '$2y$12$w3igMjsfS5XoAYuowoH3C.54vRFWlcXSHLjX7MwF990Kc2KKKh72e',
...
values (
           'foodanalytics', null, '$2a$12$wPxCgvTsujdcbdk59PgY0..b/EBvbcd1B6eYbfEVc1bLRlxYfD1Ae',
           'READ,WRITE', 'authorization_code', 'http://www.foodanalytics.local:5500/foodanalytics/', null,
           null, null, null
       );
