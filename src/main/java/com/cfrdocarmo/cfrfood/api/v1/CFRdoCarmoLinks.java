package com.cfrdocarmo.cfrfood.api.v1;

import com.cfrdocarmo.cfrfood.api.v1.controller.*;
...
public class CFRdoCarmoLinks {
    ...
    public static TemplateVariables PROJECAO_VARIABLES = new TemplateVariables(
    ...
    public Link linkToUsuarioGrupoAssociacao(Long usuarioId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class).adicionarGrupo(usuarioId, null)).withRel(rel);
    }

    public Link linkToUsuarioGrupoDesassociacao(Long usuarioId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class).removerGrupo(usuarioId, null)).withRel(rel);
    }
    ...
    public Link linkToGrupoPermissaoAssociacao(Long grupoId, String rel) {
        return linkTo(methodOn(GrupoPermissaoController.class).adicionarPermissao(grupoId, null)).withRel(rel);
    }

    public Link linkToGrupoPermissaoDesassociacao(Long grupoId, String rel) {
        return linkTo(methodOn(GrupoPermissaoController.class).removerPermissao(grupoId, null)).withRel(rel);
    }
    ...
    public Link linkToEstado(Long estadoId, String rel) {
        return linkTo(methodOn(EstadoController.class).buscarPorId(estadoId)).withRel(rel);
    }
    ...
    public Link linkToCidade(Long cidadeId, String rel) {
        return linkTo(methodOn(CidadeController.class).buscarPorId(cidadeId)).withRel(rel);
    }
    ...
    public Link linkToFotoProduto(Long restauranteId, Long produtoId, String rel) {
        return linkTo(methodOn(RestauranteProdutoFotoController.class).recuperarFoto(restauranteId, produtoId)).withRel(rel);
    }
    ...
    public Link linkToCozinha(Long cozinhaId, String rel) {
        return linkTo(methodOn(CozinhaController.class).buscarPorId(cozinhaId)).withRel(rel);
    }
