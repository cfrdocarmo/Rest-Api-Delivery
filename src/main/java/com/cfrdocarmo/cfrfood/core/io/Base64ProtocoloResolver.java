package com.cfrdocarmo.cfrfood.core.io;
...
public class Base64ProtocoloResolver implements ProtocolResolver, ApplicationListener<ApplicationContextInitializedEvent> {
